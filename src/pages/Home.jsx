      ...
      <div className="m-auto sm:w-[90%] md:w-[60%] flex sm:flex-col-reverse xl:flex-row gap-5">
        <motion.div>
          ...
          <motion.p variants={textVariant} initial="offScreen" whileInView={`onScreen`} className="sm:text-center xl:text-start text-gray-800 tracking-wide text-[16px] sm:mt-0 md:mt-10 leading-6">
            Hi, I'm Jose C. Enso III,  Front-End Developer | MERN STACK DEVELOPER | Flutter Dev Soon |
          ...
          <div className="teck-stack  flex sm:flex-col xl:flex-row items-center justify-between gap-2 xl:mt-0 sm:mt-10 ">
                ...
                <div className="tech-icons  transition grid sm:grid-cols-3 content-center justify-content-center xl:grid-cols-6 gap-5 xl:mt-0 sm:mt-0">
                  ...
                  <motion.div initial={{opacity:0, y:-50}} whileInView={{opacity:1, y:0}} transition={{duration:1.5, type:'spring', bounce:0.4}} className="w-[60px] bg-white shadow-xl rounded-full  p-3 cursor-pointer "><img className="w-full h-full object-cover" src="images/flut.jpg" alt="" /></motion.div>
                  <motion.div initial={{opacity:0, y:-50}} whileInView={{opacity:1, y:0}} transition={{duration:1.5, type:'spring', bounce:0.4}} className="w-[60px] bg-white shadow-xl rounded-full  p-3 cursor-pointer "><img className="w-full h-full object-cover" src="images/arduino.jpg" alt="" /></motion.div> 
                  ...
                  <motion.div initial={{opacity:0, y:-50}} whileInView={{opacity:1, y:0}} transition={{duration:1.5, type:'spring', bounce:0.4}} className="w-[60px] bg-white shadow-xl rounded-full  p-3 cursor-pointer "><img className="w-full h-full object-cover" src="images/azure.jpg" alt="" /></motion.div> 
